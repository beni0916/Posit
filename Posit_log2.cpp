...
#ifdef __STDC__
	Posit64 Posit_log2(Posit64 x)
#else
	Posit64 Posit_log2(x)
	Posit64 x;
#endif
{
...
int main(void)
{
	...
	cout << fixed << setprecision(16) << "nan: " << Posit_log2(nan) << "\n";
	cout << fixed << setprecision(16) << "inf: " << Posit_log2(inf) << "\n";
	cout << fixed << setprecision(16) << "max: " << Posit_log2(max) << "\n";
	cout << fixed << setprecision(16) << "min: " << Posit_log2(min) << "\n";
}
*/
