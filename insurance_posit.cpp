...
#include <iomanip>
#include "myfdlibm.h"
// g++ -std=c++17 -o insurance_posit insurance_posit.cpp Posit_fabs.cpp Posit_sqrt.cpp Posit_exp2.cpp Posit_floor.cpp
using namespace std;
int LEN = 2000;
char train_file[20] = "insurance_train.txt";
char test_file[20] = "insurance_test.txt";
char sep_word = '\t';
int total_col = 4;
int target_col = 3;
