...
#include <iomanip>
#include "myfdlibm.h"
// g++ -std=c++17 -o melb_posit melb_posit.cpp Posit_fabs.cpp Posit_sqrt.cpp Posit_exp2.cpp Posit_floor.cpp
using namespace std;
int LEN = 2500;
char train_file[30] = "melb_train.txt";
char test_file[30] = "melb_test.txt";
char sep_word = '\t';
int total_col = 13;
int target_col = 1;
