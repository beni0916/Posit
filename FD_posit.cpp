...
#include <iomanip>
#include "myfdlibm.h"
// g++ -std=c++17 -o FD_posit FD_posit.cpp Posit_fabs.cpp Posit_sqrt.cpp Posit_exp2.cpp Posit_floor.cpp
using namespace std;
int LEN = 2500;
#define arr_len 30
char train_file[30] = "FD_train.txt";
char test_file[30] = "FD_test.txt";
char sep_word = '\t';
int total_col = 86;
int target_col = 2;
