...
#include <cmath>
#include <iomanip>
// g++ -std=c++17 -o nlinear_double nlinear_double.cpp
using namespace std;

int LEN = 2000;
char train_file[30] = "linear_train.txt";
char test_file[30] = "linear_test.txt";
char sep_word = '\t';
int total_col = 10;
int target_col = 9;
...
int main(void)
{
	...
	cout << "train_b[56] = " << train_b[56] << endl;
	cout << "train_b[57] = " << train_b[57] << endl;
	cout << "train_b[58] = " << train_b[58] << endl;
    frexp(train_b, train_d1_nor_max, train_d1_nor_min);
	cout << "train_b[57] = " << train_b[57] << endl;
	...
	cout << "ATA[0] size = " << ATA[0].size() << endl;
	...
	cout << "train_d1_nor_max = " << train_d1_nor_max << endl;
	cout << "train_d1_nor_min = " << train_d1_nor_min << endl;
...
void frexp(vector<double> &src, double &max, double &min)
{
    ...
    for(int i = 0; i < src.size(); i++)
    {
        ...
        double v = src[i] / (pow(2.0, (double)e));
        double e_0 = (double)(t_max - t_min) / 2.0;
        src[i] = v * pow(2, (double)e - e_0);
    }
}