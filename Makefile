...
SRC_REMP_NEW = Posit_rempio2_new.cpp
...
$(RES_COS):
	$(CXX) $(CXXFLAGS) $(RES_COS) $(SRC_RES_COS) $(SRC_COS) $(SRC_KER_SIN) $(SRC_KER_COS) $(SRC_FABS) $(SRC_REMP_NEW) $(LIBFLAGS)

$(RES_SIN):
	$(CXX) $(CXXFLAGS) $(RES_SIN) $(SRC_RES_SIN) $(SRC_SIN) $(SRC_KER_SIN) $(SRC_KER_COS) $(SRC_FABS) $(SRC_REMP) $(LIBFLAGS)
