...
#include <iomanip>
#include "myfdlibm.h"
// g++ -std=c++17 -o HPI_posit HPI_posit.cpp Posit_fabs.cpp Posit_sqrt.cpp Posit_exp2.cpp Posit_floor.cpp
using namespace std;
int LEN = 2500;
char train_file[30] = "HPI_train1.txt";
char test_file[30] = "HPI_test1.txt";
char sep_word = '\t';
int total_col = 22;
int target_col = 21;
