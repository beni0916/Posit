...
string MPFR(double input){
    ...
    mpfr_rec_sqrt(result, x, MPFR_RNDN);
...
void Run(mt19937 generator, double *interval){
    ...
    for(int i = 0; i < 1000; i++){
        ...
        // cout << setw(10) << "MPFR: " << num1 << "\n";
        // cout << setw(10) << "Posit: " << num2 << "\n";
        // cout << setw(10) << "IEEE754: " << num3 << "\n";
