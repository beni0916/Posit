...
#ifdef __STDC__
	Posit64 Posit_log10Plus1(Posit64 x)
#else
	Posit64 Posit_log10Plus1(x)
	Posit64 x;
#endif
{
	Posit64 y, z;
...
int main(void)
{
	...
	cout << fixed << setprecision(16) << "nan: " << Posit_log10Plus1(nan) << "\n";
	cout << fixed << setprecision(16) << "inf: " << Posit_log10Plus1(inf) << "\n";
	cout << fixed << setprecision(16) << "max: " << Posit_log10Plus1(max) << "\n";
	cout << fixed << setprecision(16) << "min: " << Posit_log10Plus1(min) << "\n";
}
*/
