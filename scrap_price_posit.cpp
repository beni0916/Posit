...
#include <iomanip>
#include "myfdlibm.h"
// g++ -std=c++17 -o scrap_price_posit scrap_price_posit.cpp Posit_fabs.cpp Posit_sqrt.cpp Posit_exp2.cpp Posit_floor.cpp
using namespace std;
int LEN = 2000;
char train_file[30] = "scrap_price_train.txt";
char test_file[30] = "scrap_price_test.txt";
char sep_word = '\t';
int total_col = 15;
int target_col = 14;
